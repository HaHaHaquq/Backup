...
#define DCACHE_RAM_SIZE 8192 // RAM�Ĵ�С����λΪ�ֽ�
...
#define PIN_COMM_RX         GIO_GPIO_17
#define PIN_COMM_TX         GIO_GPIO_18
...
{
// UART1
	 SYSCTRL_ClearClkGateMulti(0 | (1 << SYSCTRL_ClkGate_APB_UART1)
								 | (1 << SYSCTRL_ClkGate_APB_PinCtrl));

    config_comm_uart(OSC_CLK_FREQ, 115200);
