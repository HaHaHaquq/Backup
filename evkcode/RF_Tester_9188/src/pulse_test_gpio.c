...
GIO_Index_t gpio_test_array[TEST_GPIO_NUM] = {TEST_PIN_0_GPIO, TEST_PIN_1_GPIO, TEST_PIN_2_GPIO, TEST_PIN_3_GPIO, TEST_PIN_4_GPIO, TEST_PIN_5_GPIO, TEST_PIN_6_GPIO, TEST_PIN_7_GPIO};
...
// GIO_Index_t gpio_test_array[TEST_GPIO_NUM] = {TEST_PIN_0_GPIO, TEST_PIN_1_GPIO, TEST_PIN_2_GPIO, TEST_PIN_3_GPIO};
